class ContentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @content.save
        format.html { redirect_to @content, notice: 'Contento creato correttamente.' }
      else
  ...
  def update
    respond_to do |format|
      if @content.update(content_params)
        format.html { redirect_to @content, notice: 'Contento aggiornato correttamente.' }
      else
  ...
  def destroy
    @content.destroy
    respond_to do |format|
      format.html { redirect_to contents_url, notice: 'Contento eliminato correttamente.' }
    end
  end
